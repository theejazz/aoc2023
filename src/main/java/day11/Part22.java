...
public class Part22 {
    ...
    public static void main(String[] args) throws IOException {
        ...
        try (InputStream input = Part22.class.getClassLoader().getResourceAsStream("day11.input");
        ...
        for (int idx = 0; idx != galaxies.size(); ++idx) {
            for (int jdx = idx + 1; jdx != galaxies.size(); ++jdx) {
                lengthSum += galaxies.get(idx).calcSpaceBetween(galaxies.get(jdx), emptyRows, emptyColumns, 1_000_000);
            }
        }
